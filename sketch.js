...
function setup() {
  ...
  block28 = new Block(740,135,30,40);
  //level three
  block29 = new Block(680,115,30,40);
  block30 = new Block(700,115,30,40);
  block31 = new Block(720,115,30,40);
  //top
  block32 = new Block(700,25,30,40);

  polygon1 = new poly(110, 100, 20, 20);

  sling = new slingshot(polygon1.body, { x: 150, y: 150 });
